...
namespace KRBTabControlTest.Win32
{
    internal partial class User32
    {
        #region Symbolic Constants

        internal const int _srcCopy = 0xCC0020;
        internal const int _htClient = 1;
        internal const int _htTransparent = -1;
        ...
        /// <summary>
        /// Specifies values from Edit Boxes Messages enumeration.If EC_USEFONTINFO is specified, the lParam parameter is ignored.
        /// </summary>
        internal enum EditBoxesMessages
        {
            EC_LEFTMARGIN = 0x1,    //Sets the left margin.
            EC_RIGHTMARGIN = 0x2,   //Sets the right margin.
            EC_USEFONTINFO = 0xFFF, //Uses information about the current font of the edit control to set the margins.For a single-line edit control, margins are set to the average width of characters in the font.
            EM_SETMARGINS = 0xD3,   //This message sets the widths of the left and right margins for an edit control. The message redraws the control to reflect the new margins.
            EM_GETMARGINS = 0xD4    //This message retrieves the widths of the left and right margins for an edit control.
        };
