...
using KRBTabControlTest.Win32;
using KRBTabControlTest.Properties;

namespace KRBTabControlTest.CustomTab
{
    [Designer(typeof(KRBTabControlDesigner))]
    class KRBTabControl : TabControl
    {
        #region Enum
        
        internal enum UpDown32Style
        {
            BlackGlass,
            OfficeBlue,
            OfficeOlive,
        ...
        internal enum TabAlignments
        {
            Bottom,
            Top
        };

        internal enum TabStyle
        {
            Sequence,
            KRBStyle
        };

        internal enum TabHeaderStyle
        {
            Solid,
            Hatch,
            Texture
        ...
        private TabPageSelector _tabSelector;
        ...
        private TabCloseImage _tabCloseBtn = TabCloseImage.Normal;      //Initializer
            ...
            if (!DesignMode)
            {
                ...
                if (drgevent.KeyState == 1 && over != null)
                {
                    ...
                    if (overringTabIndex != draggingTabIndex)
                    {
                        ...
                        if (_upArrow == null)
                            _upArrow = new ArrowWindow(Resources.UpArrow, 0.5);

                        if (_downArrow == null)
                            _downArrow = new ArrowWindow(Resources.DownArrow, 0.5);
        ...
        internal class GradientTab : IDisposable
        {
            #region Event
        ...
        internal class Hatcher : IDisposable
        {
            #region Event
